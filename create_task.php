...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    ...
    $sql = "INSERT INTO `Tasks` (`id`, `whocreated`, `forwho`, `duedate`, `importance_level`, `task`, `taskname`) VALUES (NULL, '".$_SESSION['username']."', '".$_SESSION['username']."', '$duedate', '".$_POST['urgency']."', '$task', '$taskname')";

    if(mysqli_query($conn, $sql)) echo "<script> window.location.replace('tasks.php') </script>";
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="post" action="create_task.php" style="margin-left:30%;">
