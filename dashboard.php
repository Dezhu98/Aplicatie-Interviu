...
// retrieving all the tasks for today to put them on dashboard
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<div style="width:150px;height:150px;margin-bottom:10%;margin-left:40%;" data-tilt>
					<img class="profile-image" src="upload/<?php echo $_SESSION['username']?>.jpg" alt="IMG" onerror="this.style.display='none'" />
					
				</div>
					<div style="font-size:25px;height:35px;margin-top:7%;margin-right:20%;"><?php echo $_SESSION['username']?> <bt/> <p style="font-size:14px;"><?php echo $_SESSION['role']?></p></div>
				

				<div style="width:100%;border-bottom:1px solid grey;float:right;margin-bottom:5%;">
     ...
     echo "
                    ...
                    <h3 style='text-align:center;margin-bottom:3%;'>Tasks for Today</h3>";
                
                    
                
                        // query for gettings tasks for user
                        $sql = "SELECT * from Tasks WHERE forwho ='".$_SESSION['username']."' AND duedate='$date_today' ORDER BY importance_level DESC";
                        //executing query
                ...
                ?>
					...
					<ul>
						<a style="color:black;font-weight:bolder;color:red;" href="dashboard.php"><li  class="menu-option" style="background-color:#dee0e9;">Dashboard</li></a>
